    ...
    <form class="form" method="POST" action="{{ route('atualizar.produto', $findProduto->id) }}">
        ...
        <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" value="{{ isset($findProduto->valor) ? $findProduto->valor : old('valor') }}" class="form-control @error('valor') is-invalid @enderror" name="valor" id="mascara_valor" maxlength="13">
            @if ($errors->has('valor'))
